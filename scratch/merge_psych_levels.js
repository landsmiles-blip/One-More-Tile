...
const spec = JSON.parse(fs.readFileSync('scratch/levels11_20_psych_spec.json', 'utf8'));
...
// Locate boundaries
// We want to replace from the start of Level 11 object to the end of Level 20 object
...
console.log('Successfully merged 10 Cognitive Trials (Levels 11-20) into index.html');
